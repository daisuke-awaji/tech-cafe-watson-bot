# tech-cafe-watson-bot

This is a sample template for tech-cafe-watson-bot - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name tech-cafe-watson-bot --query 'Stacks[].Outputs'
```
